...
```{r}
df1 <- read_rds(file = "data/SV_8pGFdxuCIijJyWW.rds")
```
...
create_data_dictionary <- function(dataframe) {
  dictionary <- data.frame(
    ...
    Type = sapply(dataframe, class),
    Label = sapply(dataframe, function(x) sjlabelled::get_label(x)),
